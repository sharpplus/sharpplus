...
public class BpProver extends ConstraintSystem {
    ...
    private final List<Consumer<BpProver>> deferredConstraints = new ArrayList<>();

    public BpProver(Transcript transcript, PedersenCommitment pedersenCommitment) {
    ...
    private void randomizedConstraints() {
        if (deferredConstraints.isEmpty()) {
            ...
            for (Consumer<BpProver> fn : deferredConstraints) {
                fn.accept(this);
            }
        }
    }
