...
public class InnerProductProof implements Serializable {
    ...
    public InnerProductProof(List<ECPoint> L, List<ECPoint> R, Scalar a, Scalar b) {
    	this.L = L;
    	this.R = R;
    	this.a = a;
    	this.b = b;
...
//    }
    ...
    public static class IPPVer {
        ...
        public IPPVer(List<Scalar> u_sq, List<Scalar> u_inv_sq, List<Scalar> s) {
        	this.u_sq = u_sq;
        	this.u_inv_sq = u_inv_sq;
        	this.s = s;
        }
        
        public List<Scalar> getU_sq() {
        	return u_sq;
        }

        public List<Scalar> getU_inv_sq() {
        	return u_inv_sq;
        }
        
        public List<Scalar> getS() {
        	return s;
        }
    }
}
